  ...
  <main class="form-signin w-100 m-auto">
    <form @submit.prevent="signUp">
      ...
      <div class="form-floating mb-3">
        <input type="text" class="form-control" id="full_name" placeholder="full_name" required v-model="username">
  ...
  export default {
    ...
    methods: {
      signUp() {
        ...
        createUserWithEmailAndPassword(auth, self.email, self.password)
        .then(() => {
          // update 'displayName'
          ...
          .then(() => {
            self.$parent.displayName = self.username;
          })
        })
        .catch((error) => {
          // console.log(error)
